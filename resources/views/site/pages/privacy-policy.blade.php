<x-layouts.site>
   <x-site.page-header
      ...
      :breadcrumb="[['label' => 'Início', 'url' => route('site.home')], ['label' => 'Política de Privacidade']]" />
            ...
            <div class="py-20 space-y-6">
               ...
               <section class="w-full max-w-4xl mx-auto text-primary-950 relative px-4 sm:px-6 lg:px-8">
                  ...
                  <p>
                     ...
                     currículos e a participação em pesquisas de satisfação. Ao continuar
                     utilizando o site, você concorda com os termos aqui descritos.
                  </p>
               </section>
               ...
               <section class="w-full max-w-4xl mx-auto text-primary-950 relative px-4 sm:px-6 lg:px-8">
                  ...
                  <ul class="list-disc pl-6 mt-2">
                     ...
                     <li>Plataformas de formulários e automação de marketing</li>
                     <li>Integrações com plataformas de pagamento e CRM</li>
                  </ul>
                  <p class="mt-2">
                     Cada ferramenta possui sua própria política de privacidade. Recomendamos
                     que você leia esses documentos nos sites oficiais das plataformas.
                  </p>
               </section>
               ...
               <section class="w-full max-w-4xl mx-auto text-primary-950 relative px-4 sm:px-6 lg:px-8">
                  ...
                  <ul class="list-disc pl-6 mt-2">
                     ...
                     <li>Responder a solicitações de contato e formulários</li>
                     <li>Processar doações, cadastros ou inscrições</li>
                  </ul>
               </section>
               ...
               <section class="w-full max-w-4xl mx-auto text-primary-950 relative px-4 sm:px-6 lg:px-8">
                  ...
                  <ul class="list-disc pl-6 mt-2">
                     ...
                     <li>Execução de contratos ou procedimentos preliminares relacionados</li>
                  </ul>
               </section>
               ...
               <section class="w-full max-w-4xl mx-auto text-primary-950 relative px-4 sm:px-6 lg:px-8">
                  ...
                  <p class="mt-2">
                     Os currículos recebidos podem ser compartilhados com empresas parceiras e
                     clientes da <strong>InRoche Inovação em Gestão de Pessoas</strong> que
                     estejam em busca de profissionais com perfil compatível, sempre observando
                     a finalidade original de recrutamento e a proteção dos dados pessoais.
                  </p>
                  <p class="mt-2">
                     Os dados e currículos poderão ser mantidos em nosso banco de talentos pelo
               ...
               <section class="w-full max-w-4xl mx-auto text-primary-950 relative px-4 sm:px-6 lg:px-8">
                  ...
                  <p class="mt-2">
                     As respostas coletadas podem incluir informações pessoais, opiniões e
                     feedbacks, sendo tratadas de forma confidencial e utilizadas exclusivamente
                     para fins estatísticos e de melhoria contínua.
                  </p>
                  <p class="mt-2">
                     Os resultados das pesquisas podem ser compartilhados de forma agregada e
                     anônima, sem identificação individual dos participantes.
                  </p>
               </section>
               ...
               <section class="w-full max-w-4xl mx-auto text-primary-950 relative px-4 sm:px-6 lg:px-8">
                  ...
                  <p class="mt-2">
                     Você pode alterar as permissões de cookies diretamente nas configurações
                     do seu navegador.
                  </p>
               </section>
