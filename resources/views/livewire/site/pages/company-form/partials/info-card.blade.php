...
<div class="space-y-4">
   ...
   <div class="flex items-start gap-2">
      ...
      <div class="space-y-1">
         ...
         <p class="text-neutral-900 font-medium">{{ $info['title'] ?? 'N/A' }}</p>
      </div>
   </div>
   ...
   <div class="flex items-start gap-2">
      ...
      <div class="space-y-1">
         ...
         <p class="text-neutral-900 font-medium">{{ $info['company'] ?? 'N/A' }}</p>
      </div>
   </div>
   ...
   @if($isJob)
      ...
      @if (!empty($info['formatted_salary']))
         <div class="flex items-start gap-2">
      ...
      @if (!empty($info['application_deadline']))
         <div class="flex items-start gap-2">
