<div id="privacy-modal" class="fixed bottom-4 left-4 max-w-sm md:max-w-md lg:max-w-lg bg-white border border-primary-100 rounded-lg shadow-lg p-4 z-50 transform transition-transform duration-300">
  <div class="flex flex-col space-y-3 md:flex-row md:items-center md:space-y-0 md:space-x-4">
    <p class="text-xs text-gray-700 leading-relaxed md:flex-1">
      Ao continuar navegando neste site, você concorda com o uso de cookies e com a nossa 
      <a href="{{ route('site.privacy-policy') }}" class="underline">Política de Privacidade.</a>
    </p>
    
    <button 
      id="accept-privacy" 
      class="bg-primary-600 hover:bg-primary-700 text-secondary-600 font-medium py-2 px-4 rounded-md transition-colors duration-200 text-xs md:flex-shrink-0 hover:cursor-pointer"
    >
      Eu concordo
    </button>
  </div>
