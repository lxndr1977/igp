<div class="fixed bottom-6 right-6 z-50">
   <a href="{{ config('site.whatsapp_link') }}"
      ...
      <div
         ...
         <div
            class="absolute top-1/2 left-full transform -translate-y-1/2 w-0 h-0 border-l-4 border-l-gray-800 border-t-4 border-t-transparent border-b-4 border-b-transparent">
         </div>
      </div>
   </a>
</div>
